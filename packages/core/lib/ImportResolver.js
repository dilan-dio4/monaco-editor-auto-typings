...
var ImportResolver = /** @class */ (function () {
    ...
    ImportResolver.prototype.resolveImportsInFile = function (source, parent, depth) {
        return __awaiter(this, void 0, void 0, function () {
            var imports, imports_1, imports_1_1, importCall, e_2_1;
            var e_2, _a;
    ...
    ImportResolver.prototype.resolveImportFromPackageRoot = function (importResource) {
        var _a, _b, _c, _d;
        return __awaiter(this, void 0, void 0, function () {
            var failedProgressUpdate, pkgJson, pkg, typings, typingPackageName, pkgJsonTypings, pkg_1, typings;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        if (this.options.onlySpecifiedPackages) {
                            if (!((_a = this.versions) === null || _a === void 0 ? void 0 : _a[importResource.packageName]) && !((_b = this.versions) === null || _b === void 0 ? void 0 : _b['@types/' + importResource.packageName])) {
                                invokeUpdate_1.invokeUpdate(failedProgressUpdate, this.options);
                                return [2 /*return*/];
                            }
                        }
                        return [4 /*yield*/, this.resolvePackageJson(importResource.packageName, (_c = this.versions) === null || _c === void 0 ? void 0 : _c[importResource.packageName])];
                    case 1:
                        pkgJson = _e.sent();
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.resolvePackageJson(typingPackageName, (_d = this.versions) === null || _d === void 0 ? void 0 : _d[typingPackageName])];
                    case 3:
                        pkgJsonTypings = _e.sent();
                        if (pkgJsonTypings) {
    ...
    ImportResolver.prototype.loadSourceFileContents = function (importResource) {
        return __awaiter(this, void 0, void 0, function () {
            var progressUpdatePath, failedProgressUpdate, pkgName, version, appends, source, appends_1, appends_1_1, append, fullPath, source, e_3_1;
            var e_3, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    ImportResolver.prototype.hashImportResourcePath = function (p) {
        return ImportResourcePath_1.importResourcePathToString(p);
    };
    ImportResolver.prototype.resolvePackageJson = function (packageName, version) {
        return __awaiter(this, void 0, void 0, function () {
            var uri, isAvailable, content, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        uri = path.join(packageName + (version ? "@" + version : ''), 'package.json');
                        isAvailable = false;
                        content = undefined;
                    ...
                    case 8: return [4 /*yield*/, this.sourceResolver.resolvePackageJson(packageName, version)];
                    case 9:
                        content = _b.sent();
                        if (content) {
    ...
    ImportResolver.prototype.resolveSourceFile = function (packageName, version, filePath) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        uri = path.join(packageName + (version ? "@" + version : ''), filePath);
                        isAvailable = false;
                        content = undefined;
                        if (!this.cache.isFileAvailable) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.cache.isFileAvailable(uri)];
